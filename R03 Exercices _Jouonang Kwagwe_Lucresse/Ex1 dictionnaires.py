...
print(f"Voici le courriel de l'étudiant qui a été ajouté : {ajout["courriel"]} ")
...
ajout_2 = {"courriel" : "2000000@cegepmontpetit.ca"}
etudiant.update(ajout_2)
print(f"Voici le nouveau courriel de l'étudiant : {ajout_2['courriel']}")
...
age_enlever = etudiant.pop("age")
print(f"on a enlevé l'age de l'étudiant,sa valeur était : {age_enlever} ")
...
print(f"Nous avons maintenant {nb_Paire} paires clés valeurs")